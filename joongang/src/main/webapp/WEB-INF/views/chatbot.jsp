				...
				<div class="portlet portlet-default">
					<div class="portlet-heading">
						<div class="portlet-title">
							<h4><i class="fa fa-circle text-green"></i>상담하기</h4>
						</div>
						<div class="clearfix"></div>
					</div>
					<div id="chat" class="panel-collapse collapse in">
						<div id="chatLog" class="portlet-body chat-widget" style="overflow-y: auto; width: 938px; height: 300px;">
							무엇을 도와드릴까요?
						</div>
